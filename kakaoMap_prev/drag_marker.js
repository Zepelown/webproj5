...
console.log("출발 마커 위치 - 위도: " + startLatitude + ", 경도: " + startLongitude);
});
...
console.log("도착 마커 위치 - 위도: " + arriveLatitude + ", 경도: " + arriveLongitude);
});
...
if (typeof (centerLatitude) == 'undefined')
    ...
    cenlat = centerLatitude;

if (typeof (centerLongitude) == 'undefined')
    cenlng = 129.104244;
else
    cenlng = centerLongitude;
...
// 동적으로 URL 생성
var url = 't_map.html?slat=' + encodeURIComponent(slat) + '&slng=' + encodeURIComponent(slng) + '&alat=' + encodeURIComponent(alat) + '&alng=' + encodeURIComponent(alng) + '&cenlat=' + encodeURIComponent(cenlat) + '&cenlng=' + encodeURIComponent(cenlng);
