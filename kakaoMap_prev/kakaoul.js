const $topServiceLeftDestnationBox = document.querySelector('.top_service_left_destnation_box');
const $topServiceLeftDestnationOptionBox = document.querySelector('.top_service_left_destnation_option_box');
const $topServiceLeftAroundBox = document.querySelector('.top_service_left_around_box');
const $topServiceLeftAroundOptionBox = document.querySelector('.top_service_left_around_option_box');
const $topServiceLefAround = document.querySelector('.top_service_left_around');
const $topServiceLeftDestnation = document.querySelector('.top_service_left_destnation');
const $topServiceLeftDestnationOption = document.querySelector('.top_service_left_destnation_option');
const $topServiceLeftDestnationOption2 = document.querySelector('.top_service_left_destnation_option2');
const $topServiceLeftButtonMenu = document.querySelector('.top_service_left_button_menu');
const $kakaomapMenu = document.querySelector('.kakaomap_menu');
const $kakaomapMenuHeaderExitButton = document.querySelector('.kakaomap_menu_header-exitbutton');
