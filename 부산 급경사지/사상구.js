...
const url2 = 'https://api.odcloud.kr/api/15025594/v1/uddi:be2166c3-2bc0-49bc-b743-ef3a474f7f1f_201909031203?page=1&perPage=300&returnType=JSON&serviceKey=muAzQmFBf9gOEiqBbNkzMbOmlHV9zPkNCrLf6FsdrOzZsUnb%2BPm84EInw0N1bZmrpTEGEdkXbmRRBi0cRq%2BhRA%3D%3D';
                ...
                geocoder.addressSearch(address, function (result, status) {
                    ...
                    if (status === kakao.maps.services.Status.OK) {
                        ...
                        var infoWindow = new kakao.maps.InfoWindow({
                            content: '<div style="width:150px;text-align:center;padding:6px 0;">' + '경사 : ' + name + ', 길이 : ' + name1 + '</div>'
                        });
